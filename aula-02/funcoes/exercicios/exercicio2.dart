...
(2) Criar 4 arquivos: funcoes, funções sem retorno e sem parâmetro, funções sem retorno e com parâmetro, funções com retorno e sem parâmetro, funções com retorno e com parâmetro;
